...
var pauserec = document.querySelector(".pause-btn");
var resumerec = document.querySelector(".resume-btn");
var data = [];
...
var recording = navigator.mediaDevices.getDisplayMedia({
	...
	.then(async (e) => {
		...
		resumerec.addEventListener('click', function resumeRecord(){
			recorder.resume();
			console.log("Record is resuming");
		})
		
		pauserec.addEventListener('click', function pauseRecord(){
			recorder.pause();
			console.log("Record is paused");
		})
	});
